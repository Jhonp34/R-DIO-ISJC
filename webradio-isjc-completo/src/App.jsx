...
export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#003366] via-[#3399FF] to-[#66CCFF] text-white">
      ...
      <section className="flex flex-col items-center justify-center text-center py-20 px-6">
        ...
        >
          <a href="#" className="bg-yellow-400 hover:bg-yellow-300 text-black font-semibold px-6 py-3 rounded-full shadow-lg">
            Ouça Agora
          </a>
        </motion.div>
      </section>
